        ...
        <table class="table user-list">
          ...
          <tbody v-if="listUser.length>0">
            <tr v-for="(item, index) in listUser">
              <td>
                <img class="img-circle img-responsive" v-bind:src="item.userAvatar" alt="avatar">
                <a href="#" class="user-link">{{item.fullName}}</a>
              ...
              <td style="width: 20%;">
                <a class="btn btn-sm btn-warning" href="javascript:" @click="EditUserDetail(item.userID)">
                  <i class="fa fa-edit"></i>&nbsp;Chỉnh sửa
                </a>
                <a href="javascript:" class="btn btn-sm btn-danger delete-booking" @click="DeleteUser(item.userID)">
