                ...
                <ul class="dropdown-menu dropdown-menu-right box-user" aria-labelledby="dLabel">
                  ...
                  <li class="ddmenu">
                    <a href="javascript:">
                      ...
                      Thông báo <span>(0)</span>
                    </a>
                  </li>

                  <li class="ddmenu">
                    <a href="/webleave/home/help">

                      <img alt="man" src="/Content/icon/mnhelp.png">
                      Trợ giúp
                    </a>
                  </li>
                  <li role="separator" class="divider"></li>
          ...
          <form>
            ...
            <div class="modal-body">
              ...
              <div class="text-center">
                <button type="button" class="btn btn-success mr-2" @click="Login()">Login</button>
                <button type="reset" value="Reset" class="btn btn-danger" @click="ClearForm()">Reset</button>
              </div>
            </div>
          </form>
